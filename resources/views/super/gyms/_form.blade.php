...
<div class="grid gap-4 md:grid-cols-2">
    ...
    <label class="igym-field"><span class="igym-label">{{ __('messages.started_at') }}</span><input type="date" name="subscription_started_at" value="{{ $fieldValue('subscription_started_at', $gym->exists ? optional($gym->subscription_started_at)->format('Y-m-d') : now()->toDateString()) }}" placeholder="YYYY-MM-DD" class="igym-input"></label>
    <label class="igym-field"><span class="igym-label">{{ __('messages.ends_at') }}</span><input type="date" name="subscription_ends_at" value="{{ $fieldValue('subscription_ends_at', $gym->exists ? optional($gym->subscription_ends_at)->format('Y-m-d') : now()->addYear()->toDateString()) }}" placeholder="YYYY-MM-DD" class="igym-input"></label>
</div>
