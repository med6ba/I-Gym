<x-app-layout>
    ...
    <div class="mx-auto max-w-7xl space-y-5 px-4 py-6 sm:px-6 lg:px-8">
        <form method="GET" data-ajax-filter data-ajax-target="#activity-log-results" class="flex flex-wrap items-center gap-3">
            <select name="action" class="rounded-lg border-slate-200 dark:border-slate-700 dark:bg-slate-950">
