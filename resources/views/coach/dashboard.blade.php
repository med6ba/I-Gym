<x-app-layout>
    ...
    <div class="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
        <div class="grid gap-4 md:grid-cols-3">
            ...
            <x-stat-card label="Assigned Members" :value="$assignedMembers" />
            <x-stat-card label="Attendance Rate" value="{{ $attendanceRate }}%" />
        </div>
        <div class="grid gap-6 lg:grid-cols-2">
            <x-chart-card title="Upcoming Sessions">
                <div class="space-y-3">
            ...
            <x-chart-card title="Members Needing Follow-up">
                <div class="space-y-3">
